...
export function GlobalSearchTrigger() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      setIsMac(navigator.platform.toUpperCase().indexOf("MAC") >= 0 || navigator.userAgent.includes("Mac"));
    }
  }, []);
  ...
  return (
    <Button
      ...
      className="relative flex items-center gap-2 text-xs text-muted-foreground hover:text-foreground h-9 px-3 w-40 sm:w-60 justify-between bg-muted/30 border-muted cursor-pointer"
    >
