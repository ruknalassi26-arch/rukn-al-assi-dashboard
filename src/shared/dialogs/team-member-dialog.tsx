  ...
  useEffect(() => {
    if (initialData) {
      reset({
        ...
        fullNameKu: ((initialData as unknown as Record<string, unknown>).fullNameKu as string) ?? "",
        positionEn: initialData.positionEn ?? "",
        positionAr: initialData.positionAr ?? "",
        positionKu: ((initialData as unknown as Record<string, unknown>).positionKu as string) ?? "",
        biographyEn: initialData.biographyEn ?? "",
        biographyAr: initialData.biographyAr ?? "",
        biographyKu: ((initialData as unknown as Record<string, unknown>).biographyKu as string) ?? "",
